    ...
    <div class="row">
      ...
      <script>
       ...
       red_places.push(L.marker([value.substring(0, value.lastIndexOf(",")), value.substring(value.lastIndexOf(",") +1)], {icon: redIcon}).bindPopup('<a href="#0">'.replace("0", key.substring(key.lastIndexOf("#") +1)) + key.substring(0, key.lastIndexOf("#")) + '</a> <br/>See linked documents: <a href="../indices/epidoc/places.html#0">'.replace("0", key.substring(key.lastIndexOf("#") +1)) + '➚</a>'));
        ...
        [45.21625206214063,8.293893188238146]
        ], {color: 'orange'}).bindPopup('<a href="#35">Predalbora (Piacenza)</a> <br/>See linked documents: <a href="../indices/epidoc/places.html#35">➚</a>'));
