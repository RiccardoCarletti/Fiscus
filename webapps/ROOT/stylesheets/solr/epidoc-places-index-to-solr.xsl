...
<xsl:stylesheet exclude-result-prefixes="#all"
  ...
  <xsl:template match="/">
    ...
    <xsl:variable name="not_mentioned" select="$places/tei:place/tei:placeName[not(@type='other')][not(.='XXX')][not(contains(normalize-space($all_mentions), normalize-space(concat(' ', following-sibling::tei:idno, ' '))))]"/>
