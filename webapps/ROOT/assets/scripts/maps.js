...
var streets = L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoiaXZhZ2lvbmFraXMiLCJhIjoiY2treTVmZnhyMDBzdTJ2bWxyemY4anJtNSJ9.QrP-0v-7btCzG97ll23HKw', {
        ...
        goldenIcon = new LeafIcon({iconUrl: '../../../assets/images/golden.png'});
            ...
            if (key.includes('#a')) {
            purple_places.push(L.marker([value.substring(0, value.lastIndexOf(",")), value.substring(value.lastIndexOf(",") +1)], {/*time: "1100", */icon: purpleIcon, id:key.substring(key.lastIndexOf("@") +1)}).bindPopup('<a target="_blank" href="places.html#0">'.replace("0", key.substring(key.lastIndexOf("@") +1)) + key.substring(0, key.indexOf("#")) + '</a> ' + symbols + ' <span class="block">See linked documents (' + key.substring(key.indexOf("#") +1, key.lastIndexOf("#")) + '): <a target="_blank" href="../indices/epidoc/places.html#0">'.replace("0", key.substring(key.lastIndexOf("@") +1)) + '➚</a></span>'));
            if (key.includes('c@')) {
            ...
            polygons_places.push(L.polygon([coords], {color: 'green', id:key.substring(key.lastIndexOf("@") +1)}).bindPopup('<a target="_blank" href="places.html#0">'.replace("0", key.substring(key.lastIndexOf("#") +1)) + key.substring(0, key.indexOf("#")) + '</a> <span class="block">See linked documents (' + key.substring(key.indexOf("#") +1, key.lastIndexOf("#")) + '): <a target="_blank" href="../indices/epidoc/places.html#0">'.replace("0", key.substring(key.lastIndexOf("#") +1)) + '➚</a></span>'));
            }; 
            ...
            var coords = chunkArray(split_values, 2);
            lines_places.push(L.polyline([coords], {color: 'blue', id:key.substring(key.lastIndexOf("@") +1)}).bindPopup('<a target="_blank" href="places.html#0">'.replace("0", key.substring(key.lastIndexOf("#") +1)) + key.substring(0, key.indexOf("#")) + '</a> <span class="block">See linked documents (' + key.substring(key.indexOf("#") +1, key.lastIndexOf("#")) + '): <a target="_blank" href="../indices/epidoc/places.html#0">'.replace("0", key.substring(key.lastIndexOf("#") +1)) + '➚</a></span>'));
            }; 
